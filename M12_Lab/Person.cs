...
namespace M12_Lab
{
    ...
    public class Person : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public Person(Person bestehendePerson)
        {
            Vorname = bestehendePerson.Vorname;
            Nachname = bestehendePerson.Nachname;
            Geschlecht = bestehendePerson.Geschlecht;
            Verheiratet = bestehendePerson.Verheiratet;
            Lieblingsfarbe = bestehendePerson.Lieblingsfarbe;
            Kinder = bestehendePerson.Kinder;

            Geburtsdatum = new DateTime(bestehendePerson.Geburtsdatum.Year, bestehendePerson.Geburtsdatum.Month, bestehendePerson.Geburtsdatum.Day);
        }
